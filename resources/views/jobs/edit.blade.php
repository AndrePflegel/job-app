...
<div class="job-card">
    <form action="{{ route('jobs.update', $job->id) }}" method="POST">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="title" id="title" value="{{ old('title', $job->title) }}" style="width: 100%; padding: 10px; margin-top: 6px; box-sizing: border-box;">
        </div>

        <div style="margin-bottom: 15px;">
            <label for="description"><strong>Beschreibung</strong></label><br>
            <textarea name="description" id="description" rows="6" style="width: 100%; padding: 10px; margin-top: 6px; box-sizing: border-box;">{{ old('description', $job->description) }}</textarea>
        </div>

        <div style="margin-bottom: 15px;">
            <label for="location"><strong>Ort</strong></label><br>
            <input type="text" name="location" id="location" value="{{ old('location', $job->location) }}" style="width: 100%; padding: 10px; margin-top: 6px; box-sizing: border-box;">
        </div>

        <div style="margin-bottom: 15px;">
            <label for="salary"><strong>Gehalt</strong></label><br>
            <input type="number" step="0.01" name="salary" id="salary" value="{{ old('salary', $job->salary) }}" style="width: 100%; padding: 10px; margin-top: 6px; box-sizing: border-box;">
        </div>

        <div style="margin-bottom: 15px;">
            <label for="company_id"><strong>Firma</strong></label><br>
            <select name="company_id" id="company_id" style="width: 100%; padding: 10px; margin-top: 6px; box-sizing: border-box;">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <select name="category_id" id="category_id" style="width: 100%; padding: 10px; margin-top: 6px; box-sizing: border-box;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <select name="user_id" id="user_id" style="width: 100%; padding: 10px; margin-top: 6px; box-sizing: border-box;">
                @foreach ($users as $user)
                <option value="{{ $user->id }}" @selected(old('user_id', $job->user_id) == $user->id)>
                {{ $user->name }}
                </option>
                @endforeach
            </select>
